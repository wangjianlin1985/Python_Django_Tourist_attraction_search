...
urlpatterns = [
    ...
    url(r'^Province/', include('apps.Province.urls', namespace='Province')),  # 省份模块
    url(r'^ScenicType/', include('apps.ScenicType.urls', namespace='ScenicType')),  # 景区类型模块
    url(r'^Scenic/', include('apps.Scenic.urls', namespace='Scenic')),  # 景点模块
